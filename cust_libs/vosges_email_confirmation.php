...
<div data-role="fieldcontain">
  <fieldset class="ui-grid-a top-buttons">
   ...
   <div class="ui-block-b">
    <input type="image" id="checkout_confirmation_btn" name="submit_continue" value="Submit Order" tabindex="1" class="submit btn-checkout" src="/images/submit_Order.gif" data-mini="true"/>
   </div>
  </fieldset>
</div>
...
{/if}
     ...
     {*{if $settings.paypal_express_checkout != 'y'}<input type="submit" name="submit_billing" value="Edit" class="edit_btn" />{/if}*}
       {if $settings.paypal_express_checkout != 'y'}<input type="image" name="submit_billing" value="Edit" class="submit btn-checkout" src="/images/edit.gif" />{/if}
    </td>
  </tr>
...
<table width="100%">
  ...
  <tr>
    <td class="normaltext">
      ...
      {/if}
      {if $settings.paypal_express_checkout != 'y'}<input type="image" name="submit_payment" value="Edit" class="submit" src="/images/edit.gif" />{/if}
    </td>
  </tr>
 {/if}
</table>
...
<table style="width:100%;">
  ...
  <tr style="vertical-align:top;">
    ...
    {/if}
 {if $settings.paypal_express_checkout != 'y'}<input type="image" name="submit_shipping" value="Edit" class="submit" src="/images/edit.gif" />{/if}
...
<fieldset class="ui-grid-a">
	...
	<div class="ui-block-b">
      {if $hasIssue == ''}<input type="image" name="submit_continue" value="Submit Order" tabindex="1" class="submit" src="/images/submit_Order.gif" data-mini="true"/>{/if}
	</div>
</fieldset>
    </td>
  </tr>
